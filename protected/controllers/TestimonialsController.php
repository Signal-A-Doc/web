...
use app\models\search\Testimonials as TestimonialsSearch;
 ...
 */
class TestimonialsController extends TController
{
    ...
    public function actionMass()
    {
        ...
        if (! empty($Ids)) {
            foreach ($Ids as $Id) {
                ...
                if (! empty($model && $model instanceof Testimonials)) {
    ...
    public function actionAdd()
    {
        ...
        $model->scenario = 'add';
        $model->state_id = Testimonials::STATE_ACTIVE;
    ...
    /**
     * Truncate an existing Testimonials model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', \Yii::t('app', 'Testimonials Cleared !!!'));
        return $this->redirect([
            'index'
        ]);
    }

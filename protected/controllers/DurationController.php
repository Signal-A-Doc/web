...
use app\models\search\Duration as DurationSearch;
 ...
 */
class DurationController extends TController
{
  public function behaviors() {
    ...
    public function actionAdd(/* $id*/)
    {
        ...
        $model->state_id = Duration::STATE_ACTIVE;
    ...
    /**
     * Clone an existing Duration model.
     * If update is successful, the browser will be redirected to the 'view' page.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Truncate an existing Duration model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Duration Cleared !!!');

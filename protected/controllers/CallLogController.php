...
use app\models\search\CallLog as CallLogSearch;
 ...
 */
class CallLogController extends TController
{
    ...
    public function actionMass()
    {
        ...
        if (! empty($Ids)) {
            foreach ($Ids as $Id) {
                $model = CallLog::findOne($Id);
                if (! empty($model && $model instanceof CallLog)) {
    ...
    public function actionAdd()
    {
        ...
        $model->state_id = CallLog::STATE_ACTIVE;
    ...
    /**
     * Truncate an existing CallLog model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'CallLog Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }

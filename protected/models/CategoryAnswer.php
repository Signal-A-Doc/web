...
/**
 * This is the model class for table "tbl_category_answer".
 *
 * @property integer $id
 ...
 * @property CategoryQuestion $question
 * @property User $createdBy
 */
class CategoryAnswer extends \app\components\TActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [
                ...
                'exist',
                'skipOnError' => true,
                'targetClass' => CategoryQuestion::className(),
                'targetAttribute' => [
                    'question_id' => 'id'
                ]
            ],
    ...
    {
        return $this->hasOne(CategoryQuestion::className(), [
            'id' => 'question_id'
        ]);
    }

...
/**
 * This is the model class for table "tbl_consultation_availability".
 *
 * @property integer $id
 ...
 */
class ConsultationAvailability extends \app\components\TActiveRecord
{
    ...
    {
        return '{{%consultation_availability}}';
    }
    ...
    public function asJson($with_relations = false)
    {
       ...
       // $json['image_file2'] =$this->image_file;

        ...
        return [
            'appConfig' => [
                ...
                'value' => [
                    ...
                    'companyAddress' => [
                        'type' => self::KEY_TYPE_STRING,
                        'value' => 'C-127, 4th floor, Phase 8, Industrial Area, Sector 72, Mohali, Punjab',
                        'required' => false
                    ],
                    'loginCount' => [
            ...
            'stripe' => [
                'title' => Yii::t('app', 'Stripe Configration'),
                'value' => [
                    'stripeKey' => [
                        'type' => self::KEY_TYPE_STRING,
                        'value' => 'sk_test_oxorbKKcqQsgaJvGMBL1vOjz',
                        'required' => true
                    ]
            ...
            'openTok' => [
                'title' => Yii::t('app', 'Open Tok Configration'),
                'value' => [
                    'apiKey' => [
                        'type' => self::KEY_TYPE_STRING,
                        'value' => '46269382',
                    ...
                    'secretKey' => [
                        'type' => self::KEY_TYPE_STRING,
                        'value' => '730cef9da60f3e38efccfbe2947ea5add582b680',
                        'required' => true
                    ]
            ...
            'twilio' => [
                'title' => Yii::t('app', 'Twilio Settings'),
                'value' => [
                    'sid' => [
                        'type' => self::KEY_TYPE_STRING,
                        'value' => 'sid',
            ...
            'comission' => [
                'title' => Yii::t('app', 'Comission Percentage'),
                'value' => [
                    'percentage' => [
                        'type' => self::KEY_TYPE_INT,
                        'value' => '',

...
?>
<?php if (User::isAdmin()) echo Html::a('','#',['class'=>'multiple-delete glyphicon glyphicon-trash','id'=>"bulk_delete_sub-category-grid"])?>
...
<?php Pjax::end(); ?>
<script> 
$('#bulk_delete_sub-category-grid').click(function(e) {
	e.preventDefault();
			...
			$.ajax({
				...
				success : function( response ) {
					if ( response.status == "OK" ) {
						 $.pjax.reload({container: '#sub-category-pjax-grid'});
					}
				}
		     });
		}

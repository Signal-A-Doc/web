...
<section>
    ...
    <div class="col-md-12">
    	<div class="chat-timer text-center">
    		...
    		<div class="timer"> <strong>Time Left : </strong> 00:15:00</div>
    	</div>
    </div>
    <div class="col-md-12">
    <div class="chat">
...
if($canSendMessage){
	...
	$.ajax({
		...
		data:{
			type_id:1,
			to_id:'<?php echo $patient->create_user_id ?>',
			message:message,
...
function refreshChat(){
	...
	$.ajax({
		url:'<?php echo Url::toRoute(['message/last-msg'])?>'+'?id='+'<?php echo $patient->create_user_id?>',
		data:{

...
use app\models\search\DoctorAvailability as DoctorAvailabilitySearch;
 ...
 */
class DoctorAvailabilityController extends TController
{
    ...
    public function actionMass()
    {
        ...
        if (! empty($Ids)) {
            foreach ($Ids as $Id) {
                $model = DoctorAvailability::findOne($Id);
                if (! empty($model && $model instanceof DoctorAvailability)) {
    ...
    public function actionAdd()
    {
        ...
        $model->state_id = DoctorAvailability::STATE_ACTIVE;
    ...
    /**
     * Truncate an existing DoctorAvailability model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'DoctorAvailability Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }

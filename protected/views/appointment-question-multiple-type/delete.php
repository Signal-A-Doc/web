...
<div class="wrapper">
   <div class="card">
      <div class="appointment-question-multiple-type-view card-body">
   ...
   <div class="card">
      <div class="card-body">
         ...
         ?>         <div class="col-md-12 text-right">
            <?= Html::submitButton('Confirm', ['id'=> 'appointment-question-multiple-type-form-submit','class' =>'btn btn-success']) ?>
         </div>
         <?php TActiveForm::end(); ?>
      </div>
   </div>

        ...
        if (! empty($count)) {
            ...
            if ($notifications) {
                foreach ($notifications as $notification) {
                    ...
                    $response['data'][] = [
                        'key' => $notification->id,
                        'html' => "<a class='content' data-id='{$notification->id}' href='$url'> <div class='notification-item'>     						<p class='item-title'> $notification->title   <spna class='pull-right'> $time </span></p>     						<p class='item-info'>$description</p> 					   </div> 				    </a>"
                    ];
                    $response['notification_ids'][] = $notification->id;
                }
            }
    ...
    public function actionMass()
    {
        ...
        if (! empty($Ids)) {
            foreach ($Ids as $Id) {
                ...
                if (! empty($model && $model instanceof Notification)) {

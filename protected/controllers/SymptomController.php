...
use app\models\search\Symptom as SymptomSearch;
 ...
 */
class SymptomController extends TController
{
  public function behaviors() {
    ...
    public function actionAdd(/* $id*/)
    {
        ...
        $model->state_id = Symptom::STATE_ACTIVE;
    ...
    /**
     * Clone an existing Symptom model.
     * If update is successful, the browser will be redirected to the 'view' page.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Truncate an existing Symptom model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Symptom Cleared !!!');

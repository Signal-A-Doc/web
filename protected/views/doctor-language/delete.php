...
<div class="wrapper">
   <div class="card">
      <div class="doctor-language-view card-body">
   ...
   <div class="card">
      <div class="card-body">
         ...
         'id'	=> 'doctor-language-detail-view',
         'model' => $model,
         ...
         'attributes' => [
            ...
            [
            			...
            			'format'=>'raw',
            			'value' => $model->getRelatedDataLink('language_id'),
            			],
            /*[
			'attribute' => 'state_id',
			'format'=>'raw',
         ...
         ?>         <div class="col-md-12 text-right">
            <?= Html::submitButton('Confirm', ['id'=> 'doctor-language-form-submit','class' =>'btn btn-success']) ?>
         </div>
         <?php TActiveForm::end(); ?>
      </div>
   </div>

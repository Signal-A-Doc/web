...
use app\models\search\Recommendation as RecommendationSearch;
 ...
 */
class RecommendationController extends TController
{
    ...
    public function actionMass()
    {
        ...
        if (! empty($Ids)) {
            foreach ($Ids as $Id) {
                ...
                if (! empty($model && $model instanceof Recommendation)) {
    ...
    public function actionAdd()
    {
        ...
        $model->state_id = Recommendation::STATE_ACTIVE;
    ...
    /**
     * Truncate an existing Recommendation model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Recommendation Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }

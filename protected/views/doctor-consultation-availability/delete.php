...
<div class="wrapper">
   <div class="card">
      <div class="doctor-consultation-availability-view card-body">
   ...
   <div class="card">
      <div class="card-body">
         ...
         'id'	=> 'doctor-consultation-availability-form',
         'options'=>[
         'class'=>'row'
         ]
         ]);?>
         ...
         ?>         <div class="col-md-12 text-right">
            <?= Html::submitButton('Confirm', ['id'=> 'doctor-consultation-availability-form-submit','class' =>'btn btn-success']) ?>
         </div>
         <?php TActiveForm::end(); ?>
      </div>
   </div>

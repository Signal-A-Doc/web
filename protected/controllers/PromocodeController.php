...
use app\models\search\Promocode as PromocodeSearch;
 ...
 */
class PromocodeController extends TController
{
    ...
    public function actionMass()
    {
        ...
        if (! empty($Ids)) {
            foreach ($Ids as $Id) {
                ...
                if (! empty($model && $model instanceof Promocode)) {
    ...
    public function actionAdd()
    {
        ...
        $model->state_id = Promocode::STATE_ACTIVE;
        $model->type_id = Promocode::TYPE_PROMOCODE;
            ...
            if ($model->save()) {
                ...
                if (! empty($users)) {
                    foreach ($users as $user) {
                        $message = \Yii::t('app', 'New Promocode ' . $model->promocode . ' is Added');
                        Notification::create($param = [
                            'to_user_id' => $user->id,
                            'created_by_id' => \Yii::$app->user->id,
                            'title' => $message,
                            'model' => $model,
                            'type_id' => CallLog::TYPE_PROMO
                        ]);
                    }
                }
    ...
    /**
     * Truncate an existing Promocode model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Promocode Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }

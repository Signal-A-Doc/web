...
/**
 * This is the model class for table "tbl_doctor_specialization".
 *
 * @property integer $id
...
class Doctorspecialization extends \app\components\TActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('app', 'ID'),
            'category_id' => Yii::t('app', 'Areas of specilization'),
            'categories' => Yii::t('app', 'Medical Condition'),
    ...
    public function asJson($with_relations = false)
    {
        ...
        $json['title'] = $this->category->title;
